...
enumerated_dynamic_type! {
    ...
    enum DynCellReader {
        ...
        Xml(xml::CellReader),
        Text(text::CellReader),
        Url(url::CellReader),
        Path(path::CellReader),
        Http(http::CellReader),
        Markdown(markdown::CellReader),
...
enumerated_dynamic_type! {
    ...
    enum DynCellWriter {
        ...
        Xml(xml::CellWriter),
        Text(text::CellWriter),
        Url(url::CellWriter),
        Path(path::CellWriter),
        Http(http::CellWriter),
        Markdown(markdown::CellWriter),
        TreeSitter(treesitter::Cell),
...
enumerated_dynamic_type! {
    ...
    pub(crate) enum DynCellIterator {
        ...
        Text(std::iter::Empty<Res<text::Cell>>),
        Url(std::iter::Empty<Res<url::Cell>>),
        Path(std::iter::Once<Res<path::Cell>>),
        Http(std::iter::Once<Res<http::Cell>>),
        Markdown(markdown::CellIterator),
